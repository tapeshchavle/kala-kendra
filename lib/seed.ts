...
const SEED_PRODUCTS = [
  { sellerEmail: 'ramesh@example.com', name: 'Bagh Print Cotton Saree', description: 'Exquisite Saree.', basePrice: 3500, category: 'Textiles', craftType: 'Bagh Print', images: ['https://images.unsplash.com/photo-1605518216938-7c31b7b14ad0?w=800&q=80'], videoUrl: 'https://youtube.com/shorts/bagh-saree-video', giTagged: true, status: 'active', tags: ['Bagh Print'] },
  { sellerEmail: 'lakshmi@example.com', name: 'Tree of Life Canvas', description: 'Gond tribal art.', basePrice: 5000, category: 'Paintings', craftType: 'Gond Art', images: ['https://images.unsplash.com/photo-1544815467-313d8544d930?w=800&q=80'], videoUrl: 'https://youtube.com/shorts/gond-tree', giTagged: true, status: 'active', tags: ['Gond Art'] },
  { sellerEmail: 'abdul@example.com', name: 'Chanderi Silk Saree', description: 'Woven with gold buttis.', basePrice: 8500, category: 'Textiles', craftType: 'Chanderi Weaving', images: ['https://images.unsplash.com/photo-1610996172600-4b82d921356b?w=800&q=80'], videoUrl: 'https://youtu.be/chanderi-demo', giTagged: true, status: 'active', tags: ['Chanderi'] },
  { sellerEmail: 'sunita@example.com', name: 'Bell Metal Diya', description: 'Lost-wax casting technique.', basePrice: 2000, category: 'Home Decor', craftType: 'Bell Metal Craft', images: ['https://images.unsplash.com/photo-1600078869819-3f0f5b4d7c80?w=800&q=80'], videoUrl: '', giTagged: true, status: 'active', tags: ['Bell Metal'] },
  { sellerEmail: 'mohan@example.com', name: 'Zardozi Clutch', description: 'Metallic threadwork.', basePrice: 3500, category: 'Accessories', craftType: 'Zardozi Embroidery', images: ['https://images.unsplash.com/photo-1623868516104-d5581bda7d0d?w=800&q=80'], videoUrl: 'https://youtube.com/zardozi', giTagged: false, status: 'active', tags: ['Zardozi'] },
  { sellerEmail: 'shanti@example.com', name: 'Maheshwari Cotton Silk', description: 'Lightweight elegant drape.', basePrice: 4200, category: 'Textiles', craftType: 'Maheshwari Weaving', images: ['https://images.unsplash.com/photo-1579450841208-868d44747c32?w=800&q=80'], videoUrl: '', giTagged: true, status: 'active', tags: ['Maheshwari'] },
  { sellerEmail: 'deepak@example.com', name: 'Pithora Horse Painting', description: 'Auspicious horse painting.', basePrice: 6000, category: 'Paintings', craftType: 'Pithora Painting', images: ['https://images.unsplash.com/photo-1582200384462-817abdf284dc?w=800&q=80'], videoUrl: 'https://vimeo.com/pithora', giTagged: false, status: 'active', tags: ['Pithora'] },
  { sellerEmail: 'rajendra@example.com', name: 'Brass Ganesh Idol', description: 'Divine handcrafted idol.', basePrice: 12000, category: 'Sculptures', craftType: 'Brass Craft', images: ['https://images.unsplash.com/photo-1565557760921-12f55cd29094?w=800&q=80'], videoUrl: 'https://youtube.com/brass', giTagged: true, status: 'active', tags: ['Brass'] },
  { sellerEmail: 'kamla@example.com', name: 'Tribal Bead Necklace', description: 'Colorful traditional jewelry.', basePrice: 800, category: 'Jewelry', craftType: 'Bead Work', images: ['https://images.unsplash.com/photo-1599643478524-fb5219273c5d?w=800&q=80'], videoUrl: '', giTagged: false, status: 'active', tags: ['Bead Work'] },
  { sellerEmail: 'vijay@example.com', name: 'Terracotta Horses', description: 'Bankura style horses.', basePrice: 1500, category: 'Home Decor', craftType: 'Terracotta', images: ['https://images.unsplash.com/photo-1613098314175-a83ad2e9ab25?w=800&q=80'], videoUrl: 'https://youtube.com/terracotta', giTagged: false, status: 'active', tags: ['Terracotta'] },
];
