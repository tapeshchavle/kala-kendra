...
const SEED_PRODUCTS = [
  { sellerEmail: 'ramesh@example.com', name: 'Bagh Print Cotton Saree', description: 'Exquisite Saree.', basePrice: 3500, category: 'Textiles', craftType: 'Bagh Print', images: ['/products/bagh-saree.png'], videoUrl: 'https://youtube.com/shorts/bagh-saree-video', giTagged: true, status: 'active', tags: ['Bagh Print'] },
  { sellerEmail: 'lakshmi@example.com', name: 'Tree of Life Canvas', description: 'Gond tribal art.', basePrice: 5000, category: 'Paintings', craftType: 'Gond Art', images: ['/products/gond-canvas.png'], videoUrl: 'https://youtube.com/shorts/gond-tree', giTagged: true, status: 'active', tags: ['Gond Art'] },
  { sellerEmail: 'abdul@example.com', name: 'Chanderi Silk Saree', description: 'Woven with gold buttis.', basePrice: 8500, category: 'Textiles', craftType: 'Chanderi Weaving', images: ['/products/chanderi-saree.png'], videoUrl: 'https://youtu.be/chanderi-demo', giTagged: true, status: 'active', tags: ['Chanderi'] },
  { sellerEmail: 'sunita@example.com', name: 'Bell Metal Diya', description: 'Lost-wax casting technique.', basePrice: 2000, category: 'Home Decor', craftType: 'Bell Metal Craft', images: ['/products/metal-diya.jpg'], videoUrl: '', giTagged: true, status: 'active', tags: ['Bell Metal'] },
  { sellerEmail: 'mohan@example.com', name: 'Zardozi Clutch', description: 'Metallic threadwork.', basePrice: 3500, category: 'Accessories', craftType: 'Zardozi Embroidery', images: ['/products/zardozi-clutch.jpg'], videoUrl: 'https://youtube.com/zardozi', giTagged: false, status: 'active', tags: ['Zardozi'] },
  { sellerEmail: 'shanti@example.com', name: 'Maheshwari Cotton Silk', description: 'Lightweight elegant drape.', basePrice: 4200, category: 'Textiles', craftType: 'Maheshwari Weaving', images: ['/products/maheshwari-silk.jpg'], videoUrl: '', giTagged: true, status: 'active', tags: ['Maheshwari'] },
  { sellerEmail: 'deepak@example.com', name: 'Pithora Horse Painting', description: 'Auspicious horse painting.', basePrice: 6000, category: 'Paintings', craftType: 'Pithora Painting', images: ['/products/pithora-painting.jpg'], videoUrl: 'https://vimeo.com/pithora', giTagged: false, status: 'active', tags: ['Pithora'] },
  { sellerEmail: 'rajendra@example.com', name: 'Brass Ganesh Idol', description: 'Divine handcrafted idol.', basePrice: 12000, category: 'Sculptures', craftType: 'Brass Craft', images: ['/products/brass-ganesh.png'], videoUrl: 'https://youtube.com/brass', giTagged: true, status: 'active', tags: ['Brass'] },
  { sellerEmail: 'kamla@example.com', name: 'Tribal Bead Necklace', description: 'Colorful traditional jewelry.', basePrice: 800, category: 'Jewelry', craftType: 'Bead Work', images: ['/products/bead-necklace.jpg'], videoUrl: '', giTagged: false, status: 'active', tags: ['Bead Work'] },
  { sellerEmail: 'vijay@example.com', name: 'Terracotta Horses', description: 'Bankura style horses.', basePrice: 1500, category: 'Home Decor', craftType: 'Terracotta', images: ['/products/terracotta-horses.jpg'], videoUrl: 'https://youtube.com/terracotta', giTagged: false, status: 'active', tags: ['Terracotta'] },
];
